...
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/Pages/visionDictionary.css" />
    <main>
        <section class="popularArticles inConteiner">
            ...
            <div class="breadcrumb"><span><a href="<?php echo home_url(); ?>">TOP</a></span><span>> おすすめ記事</span></div>
            <div class="categoryName"><p>おすすめ記事</p></div>
            <div class="popularTitle">
                ...
                <div class="section-title"><p class="text-top">従業員推薦記事ランキング</p></div>
            </div>
        ...
        <section class="allVision inConteiner">
            <div class="visionDictionaryTitle">
                ...
                <div class="section-title"><p class="text-top">すべての従業員推薦記事</p></div>

        ...
        <div class="container">
            <div class="footer-content flex space-between">
                <div class="footer-content-left">
                    <div class="logo"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/logo.jpg" alt="logo"></div>
                    <div class="address">有限会社ドリームチーム</div>
                    <div class="phone">
                        <p>〒227-0064　神奈川県横浜市青葉区田奈町 43-3-2F</p>
                ...
                <div class="footer-content-right">
                    <ul class="flex space-around">
                        ...
                        <li><a href="<?php echo site_url();?>/inquiry" >お問い合わせ</a></li>
                    </ul>
                </div>
            </div>
            <div id="topButton" class="topButton">TOP</div>
        </div>
        <div class="footer-background"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/backgrounds/footerBackground.png" alt=""></div>
